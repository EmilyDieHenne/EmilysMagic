...
public class ModItems {
    ...
    public static final RegistryObject<Item> ITEMS_SAPPHIRE_HELMET= ITEMS.register("sapphire_helmet",
        () -> new ItemSapphireArmor(ModSapphireMaterial.SAPPHIRE_MATERIAL, ArmorItem.Type.HELMET, new Item.Properties().stacksTo(1).defaultDurability(101)));
    public static final RegistryObject<Item> ITEMS_SAPPHIRE_CHESTPLATE = ITEMS.register("sapphire_chestplate",
        () -> new ItemSapphireArmor(ModSapphireMaterial.SAPPHIRE_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Properties().stacksTo(1).defaultDurability(101)));
    public static final RegistryObject<Item> ITEMS_SAPPHIRE_LEGGINGS = ITEMS.register("sapphire_leggings",
        () -> new ItemSapphireArmor(ModSapphireMaterial.SAPPHIRE_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Properties().stacksTo(1).defaultDurability(101)));
    public static final RegistryObject<Item> ITEMS_SAPPHIRE_BOOTS = ITEMS.register("sapphire_boots",
        () -> new ItemSapphireArmor(ModSapphireMaterial.SAPPHIRE_MATERIAL, ArmorItem.Type.BOOTS, new Item.Properties().stacksTo(1).defaultDurability(101)));
